...
[ "posts/2021-03-09-Webgardens.html" ],
[ "posts/YYYY-MM-DD-Template.html" ] ];
...
//Write the Header HTML, a series of list items containing links. HEY MOSS, THIS IS WHERE THE NAVBAR IS, IT'S HOW YOU CAN ADD NONSENSE AND JUNK TO THE NAVIGATION, CAN YOU SEEEEEEEEEEEEE?
let headerHTML = '<ul>' + 
'<li><a href="' + relativePath + '/index.html">index</a></li>' + 
'<li><a href="' + relativePath + '/projects.html">projects</a></li>' + 
'<li><a href="' + relativePath + '/archive.html">archive</a></li>' +
'<li><a href="' + relativePath + '/feedback.html">feedback</a></li>' +
'<li><a href="' + relativePath + '/about.html">about</a></li>' +
'<li><a href="' + relativePath + '/greenhouse.html">webgarden</a></li>' +
'</ul>';
